...
/**
 * The<code>Class  BigFileUploadValidator </code>
 *
 * @author benju.xie
 * @since 2018/8/14
 */
...
@Component
public class BigFileUploadValidator implements Validator {
    public static Logger logger = LoggerFactory.getLogger(BigFileUploadValidator.class);
    ...
    public void validate(Object target, Errors errors) {
        if (target instanceof VBigFileBucket) {
            VBigFileBucket bucket = (VBigFileBucket) target;
